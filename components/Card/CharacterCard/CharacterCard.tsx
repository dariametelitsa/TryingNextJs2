...
export const CharacterCard = (props: PropsType) => {
  ...
  return (
    <Card name={name}>
        <Status status={status} src={statusImages[status]}></Status>
      {/*<Image src={'/statuses/alive.png'} alt={'Is a person alive'} width={16} height={16}/>*/}
      {/*<Image src={statusImages.Alive} alt={'Is a person alive'} width={14} height={14}/>*/}
